...
**БД**: PostgreSQL 17 (последняя стабильная версия)
...
OPTIMIZATION_DEFAULT_QUALITY=85
OPTIMIZATION_MAX_WIDTH=3840
OPTIMIZATION_MAX_HEIGHT=2160

# Thumbnails (v2)
THUMBNAIL_ENABLED=false
THUMBNAIL_CACHE_MAX_AGE=31536000  # 1 year in seconds
THUMBNAIL_CLEANUP_DAYS=90
THUMBNAIL_DEFAULT_FORMAT=webp
...
- используем s3
- сервис должен быть адаптирован для использоания за кэширующим прокси типа cloudflare
